...
if __name__ == '__main__':
	fastafile = readFasta('MSDBP_7129_7060_14189_train_set.txt')
	vecencoding = DDE(fastafile)
	with open('MSDBP_7129_7060_14189_train_set_1234567.csv', 'w') as fin:
		for each in vecencoding:
			fin.write(str(each))
			fin.write('\t\n\t')
	print("Finished")
